  ...
  From my view, various Emacs windows do what they do best, but to my
  audience, the end result is sections of the laptop screen showing
  off. To see this approach in action, check out these examples of mine:
...
#+END_EXAMPLE
  ...
  source code, or show off an org-mode file as a presentation.
